		...
		<div class="row p-b-75 justify-content-center">
			<div class="col-md-10 col-lg-8 text-start">
				...
				<p class="stext-113 cl6 p-b-26">
					CITES (<strong>the Convention on International Trade in Endangered Species of Wild Fauna and Flora</strong>) is an international agreement between governments. Its aim is to ensure that international trade in specimens of wild animals and plants does not threaten the survival of the species.
				</p>
			</div>
		</div>
		...
		<div class="row p-b-75 justify-content-center">
			<div class="col-md-10 col-lg-8 text-start">
				...
				<ul style="list-style-type: disc; padding-left: 20px;">
					<li class="stext-113 cl6 p-b-26">CITES is a must require document to export the python leather goods to other countries from Indonesia.</li>
					<li class="stext-113 cl6 p-b-26">CITES is issued in Jakarta Indonesia.</li>
					<li class="stext-113 cl6 p-b-26">You need CITES no matter how many quantities of the goods that you wanted to export, maximum 200 pcs of goods (Including bags, clutch, wallet, belt, etc).</li>
					<li class="stext-113 cl6 p-b-26">Price of the CITES is IDR 7,000,000 (price could be change without confirmation).</li>
					<li class="stext-113 cl6 p-b-26">More than 200 pcs of goods, you need another CITES document (price would be adjusted depend on how many quantities of python leathers).</li>
					<li class="stext-113 cl6 p-b-26">You need permit from your own country (Every country has different rules, so please check with your government first regarding the permit). e.g. for USA the one that issued the permit is from Department of the Interior U.S. Fish and Wildlife.</li>
				</ul>
